    <!-- Topnav -->
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-app-yellow text-app-dark border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center ml-md-auto w-100 d-flex justify-content-center">
            ...
            <!-- <li class="nav-item d-sm-none">
              <a class="nav-link px-0" href="#" data-action="search-show" data-target="#navbar-search-main">
